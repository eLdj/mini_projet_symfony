 ...
 */
final class Version20190713003230 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe CHANGE id_service id_service_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe CHANGE id_service_id id_service INT NOT NULL');
