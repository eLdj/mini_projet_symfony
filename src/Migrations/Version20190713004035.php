 ...
 */
final class Version20190713004035 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employe (id INT AUTO_INCREMENT NOT NULL, id_service_id INT NOT NULL, matricule VARCHAR(30) NOT NULL, nom_complet VARCHAR(30) NOT NULL, date_naissance DATE NOT NULL, salaire INT NOT NULL, INDEX IDX_F804D3B948D62931 (id_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
