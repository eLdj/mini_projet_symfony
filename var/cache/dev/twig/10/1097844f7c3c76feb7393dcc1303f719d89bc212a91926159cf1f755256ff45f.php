...
<html>
    ...
    <body>
        <nav class=\"navbar navbar-expand-lg navbar-dark bg-dark\">
            <a class=\"navbar-brand\" href=\"#\">Entreprise SA</a>
    ...
    <body>
        <nav class=\"navbar navbar-expand-lg navbar-dark bg-dark\">
            ...
            <div class=\"collapse navbar-collapse\" id=\"navbarColor02\">
                <ul class=\"navbar-nav mr-auto\">
                    <li class=\"nav-item\">
                        <a class=\"nav-link\" href=\"{{path('all')}}\">Acceuil</a>
                    </li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link\" href=\"{{ path('gestemp')}}\">Gestion Employés</a>
                    </li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link\" href=\"{{ path('gestServ')}}\">Gestion Services</a>
                    </li>
                </ul>
            </div>
        </nav>
